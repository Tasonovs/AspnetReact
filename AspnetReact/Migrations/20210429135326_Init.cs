    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CampaignCampaignTag", x => new { x.CampaignsId, x.TagsId });
                    table.ForeignKey(
                        name: "FK_CampaignCampaignTag_Campaigns_CampaignsId",
                        column: x => x.CampaignsId,
                        principalTable: "Campaigns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CampaignCampaignTag_CampaignTags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "CampaignTags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CampaignCampaignTag_TagsId",
                table: "CampaignCampaignTag",
                column: "TagsId");
